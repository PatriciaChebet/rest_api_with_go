...
//New Service - returns a new comment service
...
//GetComment - returns comments by their IDs from the database
...
//DeleteComment - Deletes the comment from the database by the ID
